...
# Build a Neural Network using Linear Qubit States as Input
model = Sequential([
    Dense(64, activation='relu', input_shape=(N,)),  # Input Layer
...
print("Training the neural network using linear qubit states...")
